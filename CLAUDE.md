...
For all changes, write comprehensive tests

## After Making Changes

Update the .claude.md with something that fixes any problems encountered automatically in the future.